...
9.15.1 P14 패치는 이제 모든 클라우드 공급자를 위한 Cloud Volumes ONTAP 에 사용할 수 있습니다. NetApp Console 기존 시스템을 이 패치 릴리스로 업그레이드하라는 메시지가 표시됩니다.
...
9.15.1 P13 패치는 이제 모든 클라우드 공급자를 위한 Cloud Volumes ONTAP 에 사용할 수 있습니다. NetApp Console 기존 시스템을 이 패치 릴리스로 업그레이드하라는 메시지가 표시됩니다.
