...
== Google Private Service Connect 제한 사항
 ...
 https://cloud.google.com/vpc/docs/private-service-connect["Google Private Service Connect"^]Cloud Volumes ONTAP를 구축하는 VPC 내에서 를 활용하는 경우 트래픽을 필요한 으로 전달하는 DNS 레코드를 구현해야 https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-google.html["BlueXP API 엔드포인트"^] 합니다.
